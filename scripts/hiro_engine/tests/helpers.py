...
class FakeChains:
    ...
    def _snap(self, minute, strike):
        from hiro_engine.models import QuoteSnap
        if strike is None:
            return None
    ...
    def quote_view(self, day, minute, k1, k2):
        from hiro_engine.models import QuoteView
...
def resting_trade(side="sell_first", branch="B", entry_min=700, leg1_fill=40.0,
    ...
    from hiro_engine.models import RestingLimit, SimTrade
...
def qv(minute, k1=7500.0, k2=7505.0, leg1=(40.0, 40.3), leg2=(40.2, 40.5)):
    from hiro_engine.models import QuoteSnap, QuoteView
    def snap(k, q):
        if q is None:
            return None
