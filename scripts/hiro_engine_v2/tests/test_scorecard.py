...
from hiro_engine_v2.eventlog import EventLog, event_to_row
from hiro_engine_v2.models import EVENT_FIELDS, Event
from hiro_engine_v2.scorecard import (ScorecardError, stage1_filter, stage2_entries,
...
def test_stage6_criteria_statuses(config, graded):
    rows, entries, qualify, metrics = graded
    from hiro_engine_v2.scorecard import stage5_controls
