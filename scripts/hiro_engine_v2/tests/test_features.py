...
from hiro_engine_v2.features import FeatureEngine, RunMachine, apply_run_machine
...
def test_incremental_equals_frame_function(config):
    ...
    from hiro_engine_v2.feeds import load_hiro_day, load_spx_day
...
def test_run_values_match_dashboard_parquet(config):
    ...
    from hiro_engine_v2.config import REPO_ROOT
