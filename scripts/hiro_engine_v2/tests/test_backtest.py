...
from hiro_engine_v2.backtest import run_backtest
from hiro_engine_v2.eventlog import EventLog
from hiro_engine_v2.models import TIER_FULL, TIER_PRICE
...
def test_full_tier_refuses_pre_hiro_dates(config, tmp_path):
    from hiro_engine_v2.feeds import FeedError
...
def test_a_episode_must_start_inside_window(config):
    ...
    from hiro_engine_v2.models import EngineState
